---
name: 98-external-gauntlet-loop
...
Keep looping until the critic picks ours. Run the builders and critics as parallel subagents.
The structure carries over unchanged.

Keep a live progress todo updating as the work evolves so I can watch it.
```

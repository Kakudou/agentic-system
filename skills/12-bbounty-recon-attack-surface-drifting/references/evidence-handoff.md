...
The handoff is not a vulnerability report, assertion of impact, ownership finding, or authorization for testing. Do not omit contradictory evidence or convert an inconclusive result into a negative finding.

## Privacy And Scope Limits

Redact secrets, personal data, session artifacts, internal-only values, and unneeded content. Share only through the approved channel and preserve the program's retention and disclosure requirements.
